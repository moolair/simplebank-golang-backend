...
import (
	...
	mockdb "github.com/moolair/simplebank-golang-backend/db/mock"
	...
	mockwk "github.com/moolair/simplebank-golang-backend/worker/mock"
...
func randomUser(t *testing.T,

// , role string
) (user db.User, password string) {
